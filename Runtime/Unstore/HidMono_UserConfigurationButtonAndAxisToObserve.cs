...
public class HidMono_UserConfigurationButtonAndAxisToObserve : MonoBehaviour
{

    public HidMono_UserConfigurationToBoolean m_userIntent;
    public HidMono_ListenToAllDevicesInUnity m_currentDeviceList;
